...
console.log("Number of plants at eighty percent capacity: " + Math.floor(eightyPercent));

console.log("Number of plants at fifty percent capacity: " + Math.floor(fiftyPercent));

//part1 
//-----------------------------------------------------------------------------------

week1Pa = week1Np * plantArea;
console.log("Area occupied by the plants grown in the first week is " + week1Pa + " sqm");

week2Pa = week2Np * plantArea;
console.log("Area occupied by the plants grown in the second week is " + week2Pa + " sqm");

week3Pa = week3Np * plantArea;
console.log("Area occupied by the plants grown in the third week is " + week3Pa + " sqm");
...
Number of plants at eighty percent capacity: 78
Number of plants at fifty percent capacity: 49
Area occupied by the plants grown in the first week is 32 sqm
Area occupied by the plants grown in the second week is 64 sqm
Area occupied by the plants grown in the third week is 128 sqm
